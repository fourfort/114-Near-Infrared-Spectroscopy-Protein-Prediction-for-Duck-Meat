...
# === 步驟 6: 特徵波長提取（CARS） ===
def cars(X, y, n_features=23, n_iterations=50):
...
selected_wavelengths = cars(X_train_sg, Y_train, n_features=23, n_iterations=50)
...
# 統一參數
common_params = {
    'Wavelength Range (nm)': '850-1099.5',
    'MCS Sampling Iterations': 1000,
    'MCS PLS Components': 7,
    'Mahalanobis Distance Threshold (%)': 90,
    'Train-Test Split Ratio': '80:20',
    'CARS Feature Wavelengths': 23,
    'CARS Sampling Iterations': 50,
...
output_filename = f'PLS_Protein_{timestamp}.xlsx'
