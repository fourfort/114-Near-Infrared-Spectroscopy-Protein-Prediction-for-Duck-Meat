...
PARAMS = {
    ...
    'MCS_N_COMPONENTS': 10,  # MCS PLS 主成分數（用於異常值檢測）
...
plt.title('Decision Tree Structure for Ash Prediction (Max Depth 3)')
plt.show()
...
plt.title('Decision Tree Regression: Actual vs Predicted Ash')
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.show()
...
output_filename = f'DT_Ash_{timestamp}.xlsx'
