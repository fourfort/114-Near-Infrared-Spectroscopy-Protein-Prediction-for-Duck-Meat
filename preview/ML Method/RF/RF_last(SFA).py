...
# === 步驟 9: 繪製特徵重要性圖 ===
X_full_scaled = scaler_x.fit_transform(nir_transposed_df.loc[common_ids][mask][sfa_mask])
...
plt.title('Top 30 Feature Importance for SFA Prediction')
plt.grid(True)
plt.tight_layout()
plt.show()
...
plt.title('Random Forest Regression: Actual vs Predicted SFA')
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.show()
...
output_filename = f'RF_SFA_Reordered_{timestamp}.xlsx'
