...
# === 步驟 4: 光譜預處理（Savitzky-Golay + 方差特徵選擇） ===
...
# === 步驟 8: 訓練元學習器（Ridge） ===
# 根據 meta features 相關性調整 Ridge alpha
ridge_alpha = [0.1, 1, 10, 100, 1000, 10000] if avg_meta_corr > 0.7 else PARAMS['RIDGE_ALPHA']
print(f"✅ 基於 meta features 相關性調整 Ridge alpha 範圍: {ridge_alpha}")
meta_param_grid = {
