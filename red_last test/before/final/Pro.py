...
PARAMS = {
    ...
    'XGB': {
        ...
        'UVE_NOISE_VARIABLES': 500,
        'UVE_CV_FOLDS': 5,
        'N_FEATURES_TO_SELECT': 150  # 二次特徵選擇保留的波長數
    }
}
...
# 波長範圍過濾
wavelength_range = PARAMS['PLS']['WAVELENGTH_RANGE']  # (600, 1099.5)
...
for model_name in ['PLS', 'DT', 'SVM', 'RF', 'XGB']:
    ...
    # === 步驟 6: 特徵選擇與模型訓練 ===
    if model_name in ['PLS', 'XGB']:  # 對 PLS 和 XGB 應用 UVE
