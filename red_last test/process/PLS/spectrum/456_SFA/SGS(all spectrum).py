...
table.scale(1.2, 1.2)
plt.title('Evaluation Metrics for Training and Test Sets (SFA)', fontsize=16, pad=10)
plt.tight_layout()
plt.show()
...
plt.xlabel('Actual SFA Content (%)', fontsize=14)
plt.ylabel('Predicted SFA Content (%)', fontsize=14)
plt.title('PLS Regression: Actual vs Predicted SFA', fontsize=16, pad=10)
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.show()
...
base_filename = 'PLS_SFA_Standardize_Autoscaling_NoCARS'
counter = 1
