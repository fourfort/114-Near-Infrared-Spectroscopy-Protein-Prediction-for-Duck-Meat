...
# 使用 IUVE 選擇重要波長
selected_wavelength_indices = iuve_wavelength_selection(X_train_sg, Y_train, n_components=PARAMS['MCS_N_COMPONENTS'])
...
plt.title('PLS Regression: Actual vs Predicted Collagen (IUVE)')
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.show()
...
output_filename = f'PLS_Collagen_IUVE_{timestamp}.xlsx'
