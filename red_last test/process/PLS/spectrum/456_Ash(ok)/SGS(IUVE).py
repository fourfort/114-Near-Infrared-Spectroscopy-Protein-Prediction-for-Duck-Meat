...
if len(selected_wavelength_indices) == 0:
    ...
    selected_wavelength_indices = np.arange(X_train_sg.shape[1])
...
for lv in range(1, max_lv + 1):
    ...
    try:
        ...
        print(f"⚠️ 交叉驗證 (n_components={lv}) 失敗: {e}")
        continue
...
output_filename = f'PLS_Ash_IUVE_{timestamp}.xlsx'
