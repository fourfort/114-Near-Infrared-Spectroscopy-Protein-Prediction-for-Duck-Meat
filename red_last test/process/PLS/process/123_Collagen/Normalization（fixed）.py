...
# === 步驟 6: 使用 Normalization 預處理之數據 ===
X_train_selected = X_train
X_test_selected = X_test
print(f"✅ 使用 Normalization 數據，訓練集形狀: {X_train_selected.shape}, 測試集形狀: {X_test_selected.shape}")
...
base_filename = 'PLS_Collagen_SPXY_Standardize_Normalize_NoCARS_NoSG'
counter = 1
