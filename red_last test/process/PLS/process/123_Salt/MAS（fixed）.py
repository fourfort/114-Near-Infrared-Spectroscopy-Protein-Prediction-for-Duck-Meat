...
mask_mcs = monte_carlo_outlier_detection(X, Y_scaled_temp, n_iterations=PARAMS['MCS_N_ITERATIONS'], n_components=PARAMS['MCS_N_COMPONENTS'])
...
base_filename = 'PLS_Salt_Standardize_MAS_NoCARS_NoSG'
counter = 1
